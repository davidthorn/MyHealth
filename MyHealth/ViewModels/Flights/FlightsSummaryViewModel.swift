...
@MainActor
public final class FlightsSummaryViewModel: ObservableObject {
    @Published public private(set) var summary: FlightsSummary?
    @Published public private(set) var isAuthorized: Bool

    private let service: FlightsSummaryServiceProtocol
    ...
    private func startUpdates(with service: FlightsSummaryServiceProtocol) {
        guard task == nil else { return }
