...
@MainActor
public final class FlightsDetailViewModel: ObservableObject {
    @Published public private(set) var summary: FlightsSummary?
    @Published public private(set) var isAuthorized: Bool

    private let service: FlightsDetailServiceProtocol
    ...
    private func startUpdates(with service: FlightsDetailServiceProtocol) {
        guard task == nil else { return }
