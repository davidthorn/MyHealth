//
//  StandHoursDetailViewModel.swift
//  MyHealth
//
//  Created by Codex.
//
...
@MainActor
public final class StandHoursDetailViewModel: ObservableObject {
    @Published public private(set) var summary: StandHoursSummary?
    @Published public private(set) var isAuthorized: Bool

    private let service: StandHoursDetailServiceProtocol
    ...
    private func startUpdates(with service: StandHoursDetailServiceProtocol) {
        guard task == nil else { return }
