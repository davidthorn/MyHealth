//
//  StandHoursSummaryViewModel.swift
//  MyHealth
//
//  Created by Codex.
//
...
@MainActor
public final class StandHoursSummaryViewModel: ObservableObject {
    @Published public private(set) var summary: StandHoursSummary?
    @Published public private(set) var isAuthorized: Bool

    private let service: StandHoursSummaryServiceProtocol
    ...
    private func startUpdates(with service: StandHoursSummaryServiceProtocol) {
        guard task == nil else { return }
