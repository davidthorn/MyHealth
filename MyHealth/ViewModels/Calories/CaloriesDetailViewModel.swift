...
@MainActor
public final class CaloriesDetailViewModel: ObservableObject {
    @Published public private(set) var summary: CaloriesSummary?
    @Published public private(set) var isAuthorized: Bool

    private let service: CaloriesDetailServiceProtocol
    ...
    private func startUpdates(with service: CaloriesDetailServiceProtocol) {
        guard task == nil else { return }
