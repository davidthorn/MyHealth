//
//  CaloriesSummaryViewModel.swift
//  MyHealth
//
//  Created by Codex.
//
...
@MainActor
public final class CaloriesSummaryViewModel: ObservableObject {
    @Published public private(set) var summary: CaloriesSummary?
    @Published public private(set) var isAuthorized: Bool

    private let service: CaloriesSummaryServiceProtocol
    ...
    private func startUpdates(with service: CaloriesSummaryServiceProtocol) {
        guard task == nil else { return }
