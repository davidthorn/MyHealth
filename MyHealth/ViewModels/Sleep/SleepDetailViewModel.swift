...
public final class SleepDetailViewModel: ObservableObject {
    ...
    private func startUpdates(with service: SleepDetailServiceProtocol) {
        guard task == nil else { return }
