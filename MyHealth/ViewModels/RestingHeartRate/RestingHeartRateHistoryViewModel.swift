//
//  RestingHeartRateHistoryViewModel.swift
//  MyHealth
//
//  Created by Codex.
//
...
@MainActor
public final class RestingHeartRateHistoryViewModel: ObservableObject {
    @Published public private(set) var summary: RestingHeartRateSummary?
    @Published public private(set) var isAuthorized: Bool

    private let service: RestingHeartRateHistoryServiceProtocol
    ...
    private func startUpdates(with service: RestingHeartRateHistoryServiceProtocol) {
        guard task == nil else { return }
