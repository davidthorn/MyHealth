...
public final class StepsDetailViewModel: ObservableObject {
    ...
    private func startUpdates(with service: StepsDetailServiceProtocol) {
        guard task == nil else { return }
