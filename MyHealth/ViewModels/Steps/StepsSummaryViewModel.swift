...
@MainActor
public final class StepsSummaryViewModel: ObservableObject {
    @Published public private(set) var summary: StepsSummary?
    @Published public private(set) var isAuthorized: Bool

    private let service: StepsSummaryServiceProtocol
    ...
    private func startUpdates(with service: StepsSummaryServiceProtocol) {
        guard task == nil else { return }
